  ...
  return (
    <div className="bg-secondary rounded-3xl">
      ...
      <div className="p-[25px] text-white">
        <h4 className="text-xl font-semibold">Harika Pizza</h4>
        <p className="text-[15px]">
          Bu Güne Kadar Yediğiniz En Güzel Pizza Olacak 
          İncecik Hamuru Bol Malzeme İle Karışınca Tarif Edilemeyeck Lezzet
        </p>
