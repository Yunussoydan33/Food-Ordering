  ...
  return (
    <div className="mt-5 mx-4">
      <div className="p-6 bg-secondary text-white rounded-[5px]">
        <p>
          Hayatımda gördüğüm en lezzetli ve ucuz fast food restoranı herkes bu lezzetleri tatmalı
        </p>
        <div className="flex flex-col mt-4">
          <span className="text-lg font-semibold">Yunus SOYDAN</span>
          <span className="text-[15px]">Ebru SOYSAL</span>
        </div>
      </div>
